...
function OrderModal({ state, modal, seconds }) {
  ...
  return (
    <Modal
      ...
      dialogContentContainerProps={{ className: dialogContentContainerClassName }}
    >
      ...
      {state === OrderModalState.Waiting && (
        <div className="flex gap-2 justify-center items-center">
          <p className="text-5xl font-black">{persianizeSeconds(seconds)}</p>
...
export { OrderModal, OrderModalState }
